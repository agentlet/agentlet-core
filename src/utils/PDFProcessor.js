...
export default class PDFProcessor {
    ...
    /**
     * Load PDF.js (no-op since it's bundled, but kept for compatibility)
    ...
    async loadPDFJS() {
        ...
        // Wait for AgentletCore to initialize and set up PDF.js
        let attempts = 0;
        ...
        if (!this.isPDFJSAvailable()) {
            throw new Error('PDF.js library is not available. Make sure AgentletCore is properly initialized.');
        }
